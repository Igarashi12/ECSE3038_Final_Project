...
mongo_uri = "mongodb+srv://dbclient:hungryhungryhippo@cluster0.tjzit.mongodb.net/project?retryWrites=true&w=majority".format(username, password)

app = Flask(__name__)
app.config["KEY"] = "superkey"
...
if __name__ == "__main__":
    http_server = WSGIServer(("192.168.0.1", 5000), app)
